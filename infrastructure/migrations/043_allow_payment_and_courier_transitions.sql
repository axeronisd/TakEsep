-- 1. Drop check constraint and recreate it to include payment_sent, payment_verified, and arrived
ALTER TABLE delivery_orders DROP CONSTRAINT IF EXISTS chk_order_status;
...
-- 2. Redefine trigger function to support full store order state machine transitions
