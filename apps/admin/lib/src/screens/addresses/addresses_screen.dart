                          ...
                          MarkerLayer(
                            markers: [
                              ...
                              if (_selectedAddress?['_isNew'] == true)
                                Marker(
                                  point: LatLng(
                                    (_selectedAddress!['lat'] as num)
                                        .toDouble(),
                                    (_selectedAddress!['lng'] as num)
                                        .toDouble(),
                                  ),
                                  width: 44,
                                  height: 44,
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              const SizedBox(width: 6),
                              Text(
                                'Кликните на карту для добавления адреса',
                                style: TextStyle(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    const SizedBox(width: 8),
                                    Text(
                                      '${(_selectedAddress!['lat'] as num?)?.toStringAsFixed(6)}, '
                                      '${(_selectedAddress!['lng'] as num?)?.toStringAsFixed(6)}',
                                      style: TextStyle(
                              ...
                              Expanded(
                                child: SingleChildScrollView(
                                  ...
                                  child: Column(
                                    children: [
                                      _editField(_streetC, 'Улица *',
                                          Icons.signpost_rounded),
                                      const SizedBox(height: 10),
                                      _editField(_houseC, 'Дом №',
                                          Icons.home_rounded),
                                      const SizedBox(height: 10),
                                      _editField(_buildingC, 'Здание',
                                          Icons.business_rounded),
                                      const SizedBox(height: 10),
                                      _editField(_cityC, 'Город',
                                          Icons.location_city_rounded),
                                      const SizedBox(height: 10),
                                      _editField(_districtC, 'Район',
                                          Icons.map_rounded),
                                    ],
                                  ),
                                ),
