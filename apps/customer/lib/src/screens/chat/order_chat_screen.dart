...
class _OrderChatScreenState extends State<OrderChatScreen> {
  ...
  void initState() {
    ...
    _pollTimer = Timer.periodic(const Duration(seconds: 3), (_) {
      if (mounted && !_sending) {
        debugPrint('📩 Customer chat poll tick — loading messages...');
        _loadMessages();
      }
    });
  }
                ...
                children: _quickReplies.map((reply) =>
                  Padding(
                    ...
                    child: ActionChip(
                      ...
                      backgroundColor: AkJolTheme.primary.withValues(alpha: 0.08),
                      side: BorderSide(color: AkJolTheme.primary.withValues(alpha: 0.2)),
...
// ═══════════════════════════════════════════════════════════
// SYSTEM MESSAGE (auto-generated like payment confirmations)
// ═══════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════
// MESSAGE BUBBLE — Improved design
// ═══════════════════════════════════════════════════════════
