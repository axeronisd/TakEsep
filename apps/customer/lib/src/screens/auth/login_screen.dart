...
class _LoginScreenState extends State<LoginScreen>
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(fontSize: 11, color: AkJolTheme.textTertiary),
          ...
          child: Row(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  border: Border(
                    right: BorderSide(color: AkJolTheme.border),
                  ),
                ),
                child: Row(
  ...
  Widget _serviceBadge(IconData icon, String label) {
    return Container(
      ...
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(icon, size: 14, color: AkJolTheme.textSecondary),
  ...
  Future<void> _sendCode() async {
    ...
    try {
      await _auth.sendOtp(_phoneController.text);
