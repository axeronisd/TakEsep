...
class _ReportsScreenState extends ConsumerState<ReportsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget buildOpsList(List<Map<String, dynamic>> ops) {
      var filtered = ops.where((op) {
        if (_filterType != 'all' && op['type'] != _filterType) return false;
                        ...
                        if (_detailData != null) ...[
                          ...
                          Container(
                            ...
                            child: Column(children: [
                              ...
                              for (final item in (_detailData!['items'] as List))
        ...
        child: Padding(
          ...
          child:
            ...
            summaryAsync.maybeWhen(
              data: (summary) => buildSummary(summary),
              orElse: () {
                final cached = summaryAsync.valueOrNull;
                if (cached != null && cached.isNotEmpty) {
                  return buildSummary(cached);
                }
            ...
            // Operations list
            Expanded(
              child: opsAsync.maybeWhen(
                data: (ops) => buildOpsList(ops),
                orElse: () {
                  final cached = opsAsync.valueOrNull;
                  if (cached != null) {
                    return buildOpsList(cached);
                  }
