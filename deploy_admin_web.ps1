...
Write-Host "[OK] Dependencies resolved`n" -ForegroundColor Green

# -- Step 2: Build Flutter Web --
Write-Host "[2/5] Building Flutter Web (release)..." -ForegroundColor Yellow
flutter build web --release --base-href "/app/"
if ($LASTEXITCODE -ne 0) { Write-Host "[ERROR] Flutter web build failed!" -ForegroundColor Red; exit 1 }
Write-Host "[OK] Web build complete`n" -ForegroundColor Green
...
Write-Host "[OK] Deployed to docs/app`n" -ForegroundColor Green
